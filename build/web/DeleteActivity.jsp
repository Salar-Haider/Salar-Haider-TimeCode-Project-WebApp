...
<html lang="en">
  <head>
    <title>Delete Activity  - Time Code</title>
  ...
  <body data-spy="scroll" data-target=".fixed-top">
    ...
    <h1 style="color: #ffbd50">Delete Activity</h1>
        <form action="deleteActivityServlet" method="post">
            ...
            <div class="text-center">
                <button type="submit" class="btn btn-custom" name="action" value="DeleteActivity">Apply Changes</button>
