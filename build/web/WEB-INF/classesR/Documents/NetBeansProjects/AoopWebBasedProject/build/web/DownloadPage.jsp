...
<html lang="en">
  <head>
    ...
    <!-- Website Title -->
    <title>DOWNLOAD  - Time Code</title>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="text-container">
              ...
              <h1>Download Time Code</h1>
              <p class="p-large">
                Download the Desktop Appliction and Manage your time efficiently while working, and enjoy your days 
                without being late anymore
              </p>
              <a
                class="btn-solid-lg page-scroll"
                href="path/to/yourfile.extension"
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="footer-col first">
              ...
              <p class="p-small">
                We're passionate about helping people to manage their time
                efficiently
              </p>
            </div>
          </div>
