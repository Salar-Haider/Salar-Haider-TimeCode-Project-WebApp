...
<html lang="en">
  <head>
    ...
    <!-- Website Title -->
    <title>Terms Conditions -  Time Code</title>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="text-container dark">
              ...
              <p>
                TimeCode also automatically collects and receives certain
                ...
                the web page, and the web page(s) you access.
              </p>
              <p>
                When you first register for a TimeCode account, and when you use
                the we collect some
              ...
              <ul class="list-unstyled li-space-lg indent">
                ...
                <li class="media">
                  ...
                  <div class="media-body">
                    ...
                    contact details must be provided using the dedicated form
                  </div>
                </li>
                <li class="media">
                  <i class="fas fa-square"></i>
                  <div class="media-body">
                    A unique TimeCode user ID (an alphanumeric string) which is
                ...
                <li class="media">
                  ...
                  <div class="media-body">
                    ...
                    your consent and confirmation of consent are mandatory
                  </div>
                </li>
                <li class="media">
                  <i class="fas fa-square"></i>
            ...
            <div class="text-container">
              ...
              <p>
                Under no circumstances shall TimeCode be liable for any direct,
                ...
                site, even if TimeCode or an authorized representative has been
                ...
                thereof should only be provided by the user of the application.
              </p>
            </div>
            <!-- end of text-container -->
            ...
            <div class="text-container">
              ...
              <p>
                ...
                licensed under the GPL 2.0. Instead, these files inherit TimeCode
                Personal Use License. These files are given to all Clients on a
                personal use basis. You may not offer them, for
                redistribution or resale of any kind. You can?t use one of our
                themes on a HTML domain. More on HTML Vs CSS, you can read here.
                You can use our templates do develop sites for your clients and
                also for a limited amount.
              </p>
              <p>
            ...
            <div class="text-container">
              ...
              <p>
                ...
                Information in these ways, please stop using the Services if you
                don't whish to customize the template for your project.
              </p>
            </div>
            <!-- end of text-container -->
            ...
            <div class="text-container last">
              ...
              <p>
                TimeCode Landing Page uses tracking technology on the landing page,
                in the Applications, and in the Platforms, including desktop
                ...
                improve the Services. By visiting TimeCode or using the Services
                you agree to the use of cookies in your browser and HTML-based
                emails.
              </p>
              <a class="btn-solid-reg" href="Home.jsp">BACK</a>
            </div>
            <!-- end of text-container -->
          </div>
        </div>
