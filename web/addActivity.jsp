...
<html lang="en">
  <head>
    <title>Add Activity  - Time Code</title>
  ...
  <body data-spy="scroll" data-target=".fixed-top">
    ...
    <h1 style="color: #ffbd50">Add Activity</h1>
        <form action="addActivityServlet" method="post">
            ...
            <div class="form-group">
                <label for="activityName"><h4 style="color: #ffbd50" >Enter Activity Name:</h4></label>
                <input type="text" class="activityName" id="activityName" name="activityName" placeholder="Enter Activity Name" required>
            </div>
            
            <div class="form-group">
                
            <div class="form-group2">
                <label for="activityName"><h4 style="color: #ffbd50" >Enter Start Time:</h4></label>
                <input type="text" class="timeText" id="startTime" name="startTime" placeholder="Enter Start Time" required>
            </div>
            
            <div class="form-group2">
                <label for="activityName"><h4 style="color: #ffbd50" >Enter End Time:</h4></label>
                <input type="text" class="timeText" id="endTime" name="endTime" placeholder="Enter End Time" required>
            </div>
            
            </div>
            
            <div class="text-center">
                <button type="submit" class="btn btn-custom" name="action" value="addActivity">Apply Changes</button>
