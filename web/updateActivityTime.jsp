...
<html lang="en">
  <head>
    <title>Update Activity Name  - Time Code</title>
  ...
  <body data-spy="scroll" data-target=".fixed-top">
    ...
    <h1 style="color: #ffbd50">Update Activity Time</h1>
        <form action="updateActivityTimeServlet" method="post">
            ...
            <div class="form-group2">
                <label for="activityName"><h4 style="color: #ffbd50" >Enter New Start Time:</h4></label>
                <input type="text" class="timeText" id="startTime" name="startTime" placeholder="Enter New Start Time" required>
            </div>
            
            <div class="form-group2">
                <label for="activityName"><h4 style="color: #ffbd50" >Enter New End Time:</h4></label>
                <input type="text" class="timeText" id="endTime" name="endTime" placeholder="Enter New End Time" required>
            </div>
